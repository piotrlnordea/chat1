...
if check_password():
    ...
    st.set_page_config(page_title="Ask Me Anything (AMA), 's chatbot")
    st.title('Ask Me Anything!')
    st.subheader('A chatbot by and about ')
    ...
    def construct_prompt(query, df, method):
        ...
        #more about me, Francois . Answer politely using the following context
